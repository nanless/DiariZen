#!/usr/bin/env bash
#
# Export ONNX for: recipes/diar_ssl/exp/kaldi_merged_1219_all_ft_large/checkpoints/<CKPT_NAME>
#
# Output:
#   inference/models/kaldi_merged_1219_all_ft_large/<CKPT_NAME>_multilabel_hard.onnx
#
set -euo pipefail
