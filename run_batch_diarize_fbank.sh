...
EXP_NAME="kaldi_merged_1205_1207_fbank_conformer_1219_all_temp"
...
OUT_BASE_DIR="${OUT_BASE_DIR:-/root/code/own/download_gp_online_audios_for_speakerdetection_1113/original_audios_Diarizen_fbank_conformer_1219_all_temp}"
DEVICE="${DEVICE:-auto}"
