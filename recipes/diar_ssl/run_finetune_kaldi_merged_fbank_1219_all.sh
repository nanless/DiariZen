...
TMUX_SESSION_NAME="diarizen_fbank_finetune"
LOG_FILE="$SCRIPT_DIR/run_finetune_kaldi_merged_fbank_1219_all.log"
...
# 原实验配置（保持与原训练一致）
EXP_NAME="${EXP_NAME:-kaldi_merged_1205_1207_fbank_conformer_1219_all}"
DATA_OUT="$RECIPE_DIR/data/$EXP_NAME"
# 使用 epoch_0037（最好的 checkpoint），代码会识别 checkpoints/epoch_ 模式直接加载
BASE_CKPT_DIR="${BASE_CKPT_DIR:-$RECIPE_DIR/exp/$EXP_NAME/checkpoints/epoch_0016}"
