...
# Purpose: continue fine-tuning from a fixed continued-training checkpoint.
# Defaults:
...
# - single GPU: CUDA_VISIBLE_DEVICES=0, NUM_GPUS=1
# - keep batch size defaults, gradient accumulation steps: 2
#
# Examples:
#   bash run_finetune_kaldi_merged_nest_xlarge_1219_all_continue_epoch0003_1gpu_acc2.sh
#   EXP_NAME=my_next_stage PORT=11361 \
#     bash run_finetune_kaldi_merged_nest_xlarge_1219_all_continue_epoch0003_1gpu_acc2.sh
#   CKPT_DIR=/path/to/checkpoints/epoch_0003 CUDA_VISIBLE_DEVICES=1 \
#     bash run_finetune_kaldi_merged_nest_xlarge_1219_all_continue_epoch0003_1gpu_acc2.sh
...
TMUX_SESSION_NAME="diarizen_nest_xlarge_ft_continue_e0003_1gpu_acc2"
LOG_FILE="$SCRIPT_DIR/run_finetune_kaldi_merged_nest_xlarge_1219_all_continue_epoch0003_1gpu_acc2.log"
...
EXP_NAME="${EXP_NAME:-${SRC_EXP_NAME}_continue_epoch${SRC_EPOCH}_1gpu_acc2}"
