...
#       使用 tmux attach -t diarizen_fbank_train 查看训练状态。
...
TMUX_SESSION_NAME="diarizen_fbank_train"
LOG_FILE="$SCRIPT_DIR/run_train_kaldi_merged_fbank_1219_all_temp.log"
...
DATA_SRC="${DATA_SRC:-/root/group-shared/voiceprint/data/speech/speaker_diarization/kaldi_merged_1219_all_temp}"
EXP_NAME="${EXP_NAME:-kaldi_merged_1205_1207_fbank_conformer_1219_all_temp}"
