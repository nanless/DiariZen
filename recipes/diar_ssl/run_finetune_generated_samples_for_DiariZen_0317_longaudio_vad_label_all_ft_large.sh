...
FT_SOURCE_EPOCH_DIR="${FT_SOURCE_EPOCH_DIR:-$RECIPE_DIR/exp/kaldi_merged_1219_all_ft_large/checkpoints/epoch_0016}"
...
MAX_NUM_STEP_CHECKPOINTS="${MAX_NUM_STEP_CHECKPOINTS:-10}"
