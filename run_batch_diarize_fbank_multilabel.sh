...
# 运行 Fbank-Conformer Multilabel 模型推理的脚本
# 自动寻找 recipes/diar_ssl/exp/kaldi_merged_1205_1207_fbank_conformer_multilabel 下最新的配置和模型
